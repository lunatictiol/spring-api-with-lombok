...
public class JuiceControllerTest {
    ...
    void getJuiceByIdNotFound() throws Exception {
        ...
        mockMvc.perform(get(JuiceController.JUICE_PATH_WITH_ID, UUID.randomUUID()).with(jwtRequestPostProcessor))
    ...
    void createJuice() throws Exception {
        ...
        mockMvc.perform(post(JuiceController.JUICE_PATH)
                        .accept(MediaType.APPLICATION_JSON).with(jwtRequestPostProcessor)
                        .contentType(MediaType.APPLICATION_JSON)
